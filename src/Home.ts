...
class Home extends eui.Component{
    ...
    // 打开日志、排行榜、充值、农场按钮
    public open_xiaoxi:eui.Image;
    public open_wangfa:eui.Image;
    public open_fenxiang:eui.Image;
